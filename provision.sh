...
download_unless_exist http://s3.amazonaws.com/builds.basho.com/riak/2.1/2.1.0pre3/ubuntu/precise/riak_2.1.0pre3-1_amd64.deb

sudo dpkg -i riak_2.1.0pre3-1_amd64.deb
